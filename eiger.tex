...
\begin{figure}[!htb]
   ...
   \caption{Top: The measured and calculated activity of the gold foils.  Middle:  The gain factors with regard to the reflectivity off case.  Bottom:  The relative difference in gain between the measured and ideal cases.}
   \label{activation}
\end{figure}
